...
The following manifest creates a new PostgreSQL 17.1 cluster,
...
the same PostgreSQL version (in our case 17.1).
...
The manifest defines a new PostgreSQL 17.1 cluster called `cluster-clone-tls`,
